...
/**
 * Page de gestion des actualités pour les conseillers
 */
					...
					<div className="flex items-center justify-between">
						<div>
							...
							<p className="text-green-100">
								Créez et gérez les actualités pour vos clients
							</p>
						</div>
						<Link
					...
					{filteredNews.length === 0 ? (
						<div className="text-center py-12">
							...
							<p className="mt-1 text-sm text-gray-500">
								Commencez en créant une nouvelle actualité pour vos clients.
							</p>
							<div className="mt-6">
								<Link
									href="/advisor/news/create"
