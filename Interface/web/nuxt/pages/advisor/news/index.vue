  ...
  <NuxtLayout name="dashboard">
    <div class="max-w-7xl mx-auto">
      <div class="flex items-center justify-between mb-8">
        ...
        <UiButton variant="primary" @click="router.push('/advisor/news/create')">
          Créer une actualité
        </UiButton>
      </div>
        ...
        <div v-else class="space-y-4">
          ...
          >
            ...
            <div class="flex gap-2 ml-4">
              <UiButton variant="ghost" size="sm" @click="router.push(`/advisor/news/${article.id}`)">
                Modifier
              </UiButton>
...
const deleteArticle = async () => {
  ...
  try {
    deleting.value = true;
    await apiFetch(`/advisor/news/${selectedArticle.value.id}`, { method: 'DELETE' });
