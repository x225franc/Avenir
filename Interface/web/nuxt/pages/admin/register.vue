    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 px-4 py-12">
      <div class="max-w-2xl w-full">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-3xl font-bold text-white mb-2">Créer un compte directeur</h1>
          <p class="text-gray-400">Espace réservé aux directeurs AVENIR</p>
        </div>
        ...
        <UiCard padding="lg" class="backdrop-blur-sm bg-white/95">
          ...
          <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
              ...
              <NuxtLink to="/admin/login" class="text-gray-900 font-semibold hover:underline">
                Se connecter
              </NuxtLink>
            </p>
          </div>
